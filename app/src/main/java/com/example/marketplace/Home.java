...
import com.example.marketplace.Adapter.ProductoAdapter;
...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNav.setOnItemSelectedListener(item -> {
            ...
            // SEMANA 6: Manejar la navegación a la pantalla de Anuncios
                ...
                intent = new Intent(Home.this, Anuncios.class);
                startActivity(intent);
                return true;
            }
    ...
    private void configurarRecyclerView() {
        ...
        // SEMANA 5: Almacenamos la referencia en la variable de clase (productoAdapter) parausarla en el filtro
    ...
    private List<Producto> cargarProductosDePrueba() {
        ...
        lista.add(new Producto("ID003", "Libro: El Señor de los Anillos", "Edición de lujo tapa dura.",
                "29.990", "url_ficticia_3"));
