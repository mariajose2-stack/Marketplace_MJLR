...
import com.example.marketplace.Model.Mensaje;
...
public class MensajeAdapter extends RecyclerView.Adapter<MensajeAdapter.MensajeViewHolder> {
    ...
    public MensajeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.activity_mensaje, parent, false);
    ...
    public void onBindViewHolder(@NonNull MensajeViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == VIEW_TYPE_EMISOR) {
            ...
            holder.llFondo.setBackgroundResource(R.drawable.ic_launcher_background);
